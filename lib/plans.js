...
export const PLANS = {
  ...
  starter: {
    ...
    stripe_price_id:'price_1SzrFzRpcx4hqotIs7yik29z' , 
    limits: {
      properties: 5,
  ...
  pro: {
    ...
    stripe_price_id: 'price_1SzrHnRpcx4hqotIpwN9t4BW',
    limits: {
      properties: 50,
      units_per_property: 100,
      billing_history_months: -1,
      pdf_invoices: true,
      email_invoices: true,
      payment_tracking: true,
...
/**
 * Get the effective plan — if subscription_ends_at has passed, treat as free
 * This is a safety net in case the Stripe webhook is delayed
 */
